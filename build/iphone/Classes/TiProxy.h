...
//Rare exceptions to indicate a bug in the _simplecalculator code (Eg, function that a subclass should have implemented)
...
/**
 The base class for SimpleCalculator proxies.
 */

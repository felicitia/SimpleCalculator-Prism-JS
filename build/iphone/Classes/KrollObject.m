...
//@interface SimpleCalculatorObject : NSObject
//@end

@interface SimpleCalculatorObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SimpleCalculatorObject class]])
		{
			for (NSString *key in [[(SimpleCalculatorObject*)o modules] allKeys])
			{

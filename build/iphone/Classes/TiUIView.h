...
/**
 Base class for all SimpleCalculator views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the SimpleCalculator view hierarchy (such as wrapped iOS UIViews) was touched.

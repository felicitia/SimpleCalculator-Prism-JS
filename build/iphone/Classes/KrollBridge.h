...
@interface SimpleCalculatorObject : KrollCoverageObject {
#else
@interface SimpleCalculatorObject : KrollObject {
#endif
@private
...
extern NSString * SimpleCalculator$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	SimpleCalculatorObject *_simplecalculator;
    KrollObject* console;
	BOOL shutdown;

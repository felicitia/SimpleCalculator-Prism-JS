...
// in simulator we redefine to format for SimpleCalculator Developer console
...
{\
	NSString * exceptionName = [@"org.simplecalculator." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.simplecalculator";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISimpleCalculatorNativeItemNone = -1, 
	UISimpleCalculatorNativeItemSpinner = -2,
	UISimpleCalculatorNativeItemProgressBar = -3,
	
	UISimpleCalculatorNativeItemSlider = -4,
	UISimpleCalculatorNativeItemSwitch = -5,
	UISimpleCalculatorNativeItemMultiButton = -6,
	UISimpleCalculatorNativeItemSegmented = -7,
	
	UISimpleCalculatorNativeItemTextView = -8,
	UISimpleCalculatorNativeItemTextField = -9,
	UISimpleCalculatorNativeItemSearchBar = -10,
	
	UISimpleCalculatorNativeItemPicker = -11,
	UISimpleCalculatorNativeItemDatePicker = -12,
	
	UISimpleCalculatorNativeItemInfoLight = -13,
	UISimpleCalculatorNativeItemInfoDark = -14,
	
	UISimpleCalculatorNativeItemDisclosure = -15,
	
	UISimpleCalculatorNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SimpleCalculator instances of
